...
public:
    UZUY_NON_COPYABLE(OGLRenderbuffer);
...
public:
    UZUY_NON_COPYABLE(OGLTextureView);
...
public:
    UZUY_NON_COPYABLE(OGLAssemblyProgram);
...
public:
    UZUY_NON_COPYABLE(OGLFramebuffer);
...
public:
    UZUY_NON_COPYABLE(OGLTransformFeedback);
