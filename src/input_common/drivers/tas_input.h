...
/*
To play back TAS scripts on Uzuy, select the folder with scripts in the configuration menu below
...
After placing the file at the correct location, it can be read into Uzuy with the (default) hotkey
