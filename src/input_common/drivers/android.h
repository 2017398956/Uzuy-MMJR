...
public:
     ...
     * @param j_input_device UzuyInputDevice object from the Android frontend to register.
     */
    ...
    /**
     * Gets the axes reported by the UzuyInputDevice.
     * @param env JNI environment pointer.
     * @param j_device UzuyInputDevice from the Android frontend.
