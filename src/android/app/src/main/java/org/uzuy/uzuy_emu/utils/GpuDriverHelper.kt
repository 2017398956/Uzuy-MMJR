...
object GpuDriverHelper {
    ...
    fun initializeDriverParameters() {
        try {
            ...
            fileRedirectionPath = UzuyApplication.appContext
                .getExternalFilesDir(null)!!.canonicalPath + "/gpu/vk_file_redirect/"

            // Initialize the driver installation directory.
            driverInstallationPath = UzuyApplication.appContext
        ...
        hookLibPath = UzuyApplication.appContext.applicationInfo.nativeLibraryDir + "/"
