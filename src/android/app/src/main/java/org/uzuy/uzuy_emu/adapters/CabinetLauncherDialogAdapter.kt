...
import org.uzuy.uzuy_emu.databinding.DialogListItemBinding
import org.uzuy.uzuy_emu.model.CabinetMode
import org.uzuy.uzuy_emu.adapters.CabinetLauncherDialogAdapter.CabinetModeViewHolder
...
class CabinetLauncherDialogAdapter(val fragment: Fragment) :
    ...
    inner class CabinetModeViewHolder(val binding: DialogListItemBinding) :
        ...
        private fun onClick(mode: CabinetMode) {
            ...
            val appletGame = Game(
                title = UzuyApplication.appContext.getString(R.string.cabinet_applet),
                path = appletPath
            )
