...
class CompressedStorage : public IReadOnlyStorage {
    UZUY_NON_COPYABLE(CompressedStorage);
    UZUY_NON_MOVEABLE(CompressedStorage);
...
private:
    class CompressedStorageCore {
        UZUY_NON_COPYABLE(CompressedStorageCore);
        UZUY_NON_MOVEABLE(CompressedStorageCore);
    ...
    class CacheManager {
        UZUY_NON_COPYABLE(CacheManager);
        UZUY_NON_MOVEABLE(CacheManager);
