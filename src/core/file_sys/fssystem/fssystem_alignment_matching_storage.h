...
class AlignmentMatchingStorage : public IStorage {
    UZUY_NON_COPYABLE(AlignmentMatchingStorage);
    UZUY_NON_MOVEABLE(AlignmentMatchingStorage);
...
class AlignmentMatchingStoragePooledBuffer : public IStorage {
    UZUY_NON_COPYABLE(AlignmentMatchingStoragePooledBuffer);
    UZUY_NON_MOVEABLE(AlignmentMatchingStoragePooledBuffer);
