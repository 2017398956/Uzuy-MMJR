...
class NcaReader {
    UZUY_NON_COPYABLE(NcaReader);
    UZUY_NON_MOVEABLE(NcaReader);
...
class NcaFsHeaderReader {
    UZUY_NON_COPYABLE(NcaFsHeaderReader);
    UZUY_NON_MOVEABLE(NcaFsHeaderReader);
...
class NcaFileSystemDriver {
    UZUY_NON_COPYABLE(NcaFileSystemDriver);
    UZUY_NON_MOVEABLE(NcaFileSystemDriver);
