...
class VfsFilesystem {
public:
    UZUY_NON_COPYABLE(VfsFilesystem);
    UZUY_NON_MOVEABLE(VfsFilesystem);
...
class VfsFile {
public:
    UZUY_NON_COPYABLE(VfsFile);
    UZUY_NON_MOVEABLE(VfsFile);
...
class VfsDirectory {
public:
    UZUY_NON_COPYABLE(VfsDirectory);
    UZUY_NON_MOVEABLE(VfsDirectory);
