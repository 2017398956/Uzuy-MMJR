...
public:
    ...
    // poses quite a challenge. Instead of creating a new meta NCA for this file, uzuy will create a
    // dir inside the NAND called 'uzuy_meta' and store the raw CNMT there.
...
private:
    ...
    bool RawInstallUzuyMeta(const CNMT& cnmt);
    ...
    // maps tid -> meta for CNMT in uzuy_meta
    std::map<u64, CNMT> uzuy_meta;
};
