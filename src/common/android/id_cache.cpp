...
static jclass s_uzuy_input_device_interface;
static jmethodID s_uzuy_input_device_get_name;
static jmethodID s_uzuy_input_device_get_guid;
static jmethodID s_uzuy_input_device_get_port;
static jmethodID s_uzuy_input_device_get_supports_vibration;
static jmethodID s_uzuy_input_device_vibrate;
static jmethodID s_uzuy_input_device_get_axes;
static jmethodID s_uzuy_input_device_has_keys;
...
jclass GetUzuyInputDeviceInterface() {
    return s_uzuy_input_device_interface;
}

jmethodID GetUzuyDeviceGetName() {
    return s_uzuy_input_device_get_name;
}

jmethodID GetUzuyDeviceGetGUID() {
    return s_uzuy_input_device_get_guid;
}

jmethodID GetUzuyDeviceGetPort() {
    return s_uzuy_input_device_get_port;
}

jmethodID GetUzuyDeviceGetSupportsVibration() {
    return s_uzuy_input_device_get_supports_vibration;
}

jmethodID GetUzuyDeviceVibrate() {
    return s_uzuy_input_device_vibrate;
}

jmethodID GetUzuyDeviceGetAxes() {
    return s_uzuy_input_device_get_axes;
}

jmethodID GetUzuyDeviceHasKeys() {
    return s_uzuy_input_device_has_keys;
}
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    const jclass native_library_class = env->FindClass("org/uzuy/uzuy_emu/NativeLibrary");
    s_native_library_class = reinterpret_cast<jclass>(env->NewGlobalRef(native_library_class));
    s_disk_cache_progress_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("org/uzuy/uzuy_emu/disk_shader_cache/DiskShaderCacheProgress")));
    s_load_callback_stage_class = reinterpret_cast<jclass>(env->NewGlobalRef(env->FindClass(
        "org/uzuy/uzuy_emu/disk_shader_cache/DiskShaderCacheProgress$LoadCallbackStage")));

    const jclass game_dir_class = env->FindClass("org/uzuy/uzuy_emu/model/GameDir");
    ...
    const jclass game_class = env->FindClass("org/uzuy/uzuy_emu/model/Game");
    ...
    const jclass overlay_control_data_class =
        env->FindClass("org/uzuy/uzuy_emu/overlay/model/OverlayControlData");
    ...
    const jclass patch_class = env->FindClass("org/uzuy/uzuy_emu/model/Patch");
    ...
    const jclass player_input_class =
        env->FindClass("org/uzuy/uzuy_emu/features/input/model/PlayerInput");
    ...
    const jclass uzuy_input_device_interface =
        env->FindClass("org/uzuy/uzuy_emu/features/input/UzuyInputDevice");
    s_uzuy_input_device_interface =
        reinterpret_cast<jclass>(env->NewGlobalRef(uzuy_input_device_interface));
    s_uzuy_input_device_get_name =
        env->GetMethodID(uzuy_input_device_interface, "getName", "()Ljava/lang/String;");
    s_uzuy_input_device_get_guid =
        env->GetMethodID(uzuy_input_device_interface, "getGUID", "()Ljava/lang/String;");
    s_uzuy_input_device_get_port = env->GetMethodID(uzuy_input_device_interface, "getPort", "()I");
    s_uzuy_input_device_get_supports_vibration =
        env->GetMethodID(uzuy_input_device_interface, "getSupportsVibration", "()Z");
    s_uzuy_input_device_vibrate = env->GetMethodID(uzuy_input_device_interface, "vibrate", "(F)V");
    s_uzuy_input_device_get_axes =
        env->GetMethodID(uzuy_input_device_interface, "getAxes", "()[Ljava/lang/Integer;");
    s_uzuy_input_device_has_keys =
        env->GetMethodID(uzuy_input_device_interface, "hasKeys", "([I)[Z");
    env->DeleteLocalRef(uzuy_input_device_interface);
...
void JNI_OnUnload(JavaVM* vm, void* reserved) {
    ...
    env->DeleteGlobalRef(s_uzuy_input_device_interface);
